...
<body style="background-color: black;">
    ...
    <form method="POST">
        ...
        <div class="pt-2 text-center w-full">
            <a href="createAccount.php" style="text-decoration: none;">Don't have an Account <span style="background-color: crimson; padding: 0px 5px; border-radius: 5px;cursor: pointer;">Create here</span></a>
        </div>
